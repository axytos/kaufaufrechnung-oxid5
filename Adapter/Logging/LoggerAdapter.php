...
namespace Axytos\KaufAufRechnung_OXID5\Adapter\Logging;

use Axytos\KaufAufRechnung\Core\Plugin\Abstractions\Logging\LoggerAdapterInterface;
use Axytos\KaufAufRechnung_OXID5\Logging\LoggerAdapter as PluginLogger;

class LoggerAdapter implements LoggerAdapterInterface
{
    /**
     * @var \Axytos\KaufAufRechnung_OXID5\Logging\LoggerAdapter
     */
    private $logger;
